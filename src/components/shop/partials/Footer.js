// Change Lorem in 19 and 34 lines with your website name
  ...
  return (
    ...
    <div className="flex sm:flex-row items-center sm:justify-between flex-col">
        ...
        <Link to="/" className="flex items-center mb-2 sm:mb-0">
            <span className="self-center tracking-[0.7rem] ml-3 font-bold uppercase sm:text-[27px] text-2xl text-white">ChessStore</span>
        </Link>
    ...
    <div className="flex flex-col-reverse sm:flex-row items-center sm:justify-between">
        ...
        <span className="sm:text-base md:text-lg text-sm  sm:text-center text-gray-400">© {moment().format("YYYY")} <a href="/" className="hover:underline">ChessStore</a>. All Rights Reserved.
        </span>
        <div className="flex my-2 sm:my-0 space-x-6 sm:justify-center ">
            {/* Facebook link */}
            <a href="https://www.facebook.com/profile.php?id=61557400585835&mibextid=ZbWKwL."target="_blank" className="text-gray-500  hover:text-white">
