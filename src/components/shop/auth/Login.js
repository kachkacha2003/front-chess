...
const Login = (props) => {
  ...
  return (
    <Fragment>
      {isLogin ? (
        <>
          <div className="text-center text-2xl font-medium mb-6">ავტორიზაცია</div>
          {layoutData.loginSignupError ? (
            <div className="bg-red-200 py-2 px-4 rounded text-center">
              საჭიროა ავტორიზაციის გავლა. არ გაქვს აქაუნთი? შექმენი
          ...
          <form className="space-y-4">
            <div className="flex flex-col">
              <label htmlFor="name" className="text-sm text-gray-600">
               ელფოსტა<span className="ml-1">*</span>
              </label>
              <input
                onChange={(e) => {
